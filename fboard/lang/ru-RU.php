...
'your_admin_psw' => 'Пароль администратора',
'site_mail' => 'Ваш email',
'install' => 'Установить',
'installed_title' => '<i class="fa fa-bullhorn"></i> Flatboard установлен',
'installed_msg' => 'Теперь можно содавать форумы! Если нужна помощь, обратитесь к <a href="http://flatboard.free.fr/view.php/plugin/page/p/docs">документации</a>.',
...
'standard_edition' => 'Стандартный - <a class="btn btn-link" href="http://flatboard.free.fr/download.php" onclick="window.open(this.href); return false;">Перейти на Flatboard PRO</a>',
...
'trip' => 'Имя ' .Util::Help('Не нужно регистрироваться, просто вводите одно и то же имя@пароль по Вашему выбору каждый раз или оставьте поле пустым для анонимной публикации. Ваш пароль будет отображаться зашифрованным и хэшированным для посетителей по соображениям безопасности!'),
...
'powered' => 'Создано на <a href="http://flatboard.free.fr" onclick="window.open(this.href); return false;">Flatboard' .(defined('FLATBOARD_PRO')?' PRO':''). '</a> с <i class="fa fa-heart"></i>',
'feed' => 'RSS-лента',
'none' => 'Ничего нет',
'info' => 'Информация',
'date' => 'Дата',
