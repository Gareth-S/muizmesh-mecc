...
'your_admin_psw' => 'Gib Dein Admin-Passwort hier ein',
...
'installed_msg' => 'Jetzt kannst Du Foren anlegen und Diskussionen mit der Welt führen! Hilfe notwendig? Gehe auf <a href="http://flatboard.free.fr/view.php/plugin/page/p/docs">und lies die Doku (DOC)</a>.',
...
'maintenance_desc' => ' Forumseite ist wegen Wartungsarbeiten offline. Bitte später nochmal wiederkommen. :-)',
'ban_list' => 'Sperrliste',
'ban_ok'  => 'Diese IP-Addresse ist jetzt gesperrt. ',
'ban_fail' => 'Diese IP-Adresse ist schon gesperrt. ',
'dashboard' => 'Dashboard',
'add_worker' => 'Hinzufügen eines Benutzers',
'save' => 'Speichern',
'update' => 'Update ',
'theme' => 'CSS-Design',
...
'cache_clean' => 'Cache gelöscht',
'folder_deleted' => 'Verzeichnis erfolgreich gelöscht',
'folder_error' => 'Verzeichnis konnte nicht gelöscht werden (Error)',
'lang' => 'Sprache',
'editor' => 'Editor',
'bbcode' => 'BBcode',
'markdown' => 'Markdown',
...
'nb_page_scroll_desc' => 'Angabe 1 unterbindet das automatische scrollen.',
'salt' => 'Sicherheitsschlüssel',
'salt_desc' => 'Leere Zeile erzeugt einen neuen Sicherheitsschlüssel',
'manage_tags' => 'Tags verwalten',
'tags' => 'Tags',
'tags_help' => 'Mit Tags können die Titel der Artikel hervorgehoben werden. Sie machen die Artikel attraktiver und dienen auch als Filter für die Suche.<br />Zum Anzeigen, bitte einen Tag in diese Liste eintragen. Im Formular für einen neuen Artikel wird die Tag-Auswahl angezeigt. ',
'tags_empty' => 'Tags-Liste ist leer!',
'replace' => 'Ersetzen',
'tags_result' => 'Ergebnis',
'blog' => 'Blog',
'blog_new' => 'Wähle ein Forum, welches eine News in deinen Blog sendet.',
...
'standard_edition' => 'Standard - <a class="btn btn-link" href="http://flatboard.free.fr/download.php" onclick="window.open(this.href); return false;">Aktualisiere auf Flatboard PRO</a>',
...
/************* add.php ***************/
'topic_added' => 'Thema hinzugefügt!',
'reply_added' => 'Antwort hinzugefügt!',
'forum_added' => 'Forum hinzugefügt!',
'write_post' => 'Schreibe einen Artikel ...',
'modo_added' => 'Neuer Benutzer hinzugefügt!',
'trip' => 'Pseudonym ' .Util::Help('Du must hier nichts eintragen. Benutze denselben Namen@password wie immer oder lasse den Eintrag für einen anonymen Artikel leer. Aus Sicherheitsgründen wird Dein password verschlüsselt angezeigt!'),
...
'email_sent' => 'E-Mail erfolgreich übertragen',
'email_nosent' => 'E-Mail konnte nicht gesendet werden',
'report_desc' => 'Hinweis: Der Moderator wird auf die von dir gemeldeten Seiten aufmerksam gemacht.<br />Dieses Formular ist NUR für die Meldung von anstößigen Inhalten und sollte nicht als Mittel zur Kommunikation mit Moderatoren aus anderen Gründen verwendet werden.',
'your_email' => 'Deine E-Mail-Adresse',
'click_to_view_post' => 'Hier klicken, um sich den Artikel anzusehen',
'order' => 'Auftrag',
'flood_start' => 'Es müssen mindestens 60 Sekunden zwischen dem Schreiben von mehreren Artikeln vergehen. Warte bitte und versuche es %s Minuten später noch einmal.',
...
'forum_deleted' => 'Forum gelöscht!',
'worker_deleted' => 'Benutzer gelöscht!',
'ip_not_banned' => 'Diese IP-Adresse war nicht gesperrt. ',
'ip_removed' => 'Diese IP-Adresse wurde entfernt.',

/************* edit.php ***************/
'topic_edited' => 'Thema wurde geändert!',
'reply_edited' => 'Antwort wurde geändert!',
'forum_edited' => 'Forum wurde geändert!',
'pinned_homepage' => 'Angepinnt auf der Homepage',
'pick_font' => 'Wähle ein Piktogramm',
'useSpace' => true,
'home' => 'Startseite',
'thread_sug'  => 'Vorgeschlagene Themen',
'change_pwd'  => 'Mein Passwort ändern',
'topic' => 'Thema',
...
'name' => 'Name',
'mail' => 'E-Mail',
'mail_desc' => 'nicht der Öffentlichkeit zeigen',
'not_required' => '(nicht benötigt)',
'search' => 'Suchen',
'forum' => 'Forum',
'password' => 'Passwort',
'confirm_password' => 'Bestätigung des Passworts',
'powered' => 'Erstellt mit <a href="http://flatboard.free.fr" onclick="window.open(this.href); return false;">Flatboard' .(defined('FLATBOARD_PRO')?' Pro':''). '</a> and <i class="fa fa-heart"></i>.',
'feed' => 'Feed',
...
'no' => 'Nein',
'locked' => 'gesperrt',
'no_reply' => 'Keine Antwort möglich',
...
'notFound' => 'Hupsi! Diese Seite existiert nicht :(',
'errNotMatch' => 'Passwort stimmt nicht überein',
'captcha' => 'Captcha',
...
'mail_not_available' => 'Funktion zum Versenden von E-Mails gestört',
'statistics' => 'Statistik',
'start' => '<div class="alert alert-primary" role="alert"><h6>Herzlichen Glückwunsch! Flatboard ist jetzt korrekt installiert.</h6>Um zu beginnen, musst du ein Forum hinzufügen. <a href="add.php/forum" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a></div>',
...
'edit_password' => 'Ändere dein Passwort',
'login_confirm' => 'Einloggen war erfolgreich.',
'logout_confirm' => 'Ausloggen war erfolgreich.',
'incorrect_password' => 'Falsches Passwort.',
'error_maxlogin' => 'Zu häufige fehlerhafte Eingabe. Probiere es in % s Minuten nochmal.',
...
'your_banned' => 'Du wurdest dauerhaft für dieses Forum gesperrt. <br />Bitte mit dem Administrator Kontakt aufnehmen, um die Gründe zu erfahren.<br />Ein Grund für die Sperrung ist unsere Weigerung gegen Spam,<br />Deine IP-Adresse: ',
