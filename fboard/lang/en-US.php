...
'your_admin_psw' => 'Your admin password account here',
'site_mail' => 'Your admin mail account here',
'install' => 'Install',
'installed_title' => '<i class="fa fa-bullhorn"></i> Yeah! Flatboard is now installed',
'installed_msg' => 'Now, create forums and start discussing with the world! Need help? Please <a href="http://flatboard.free.fr/view.php/plugin/page/p/docs">read the DOC</a>.',
...
'trip' => 'Pseudo ' .Util::Help('There is no need to “register”, just enter the same name@password of your choice every time, or leave blank for anonymous post. Your password will be displayed encrypted and hashed to visitors for security reasons!'),
...
'powered' => 'Created with <a href="http://flatboard.free.fr" onclick="window.open(this.href); return false;">Flatboard' .(defined('FLATBOARD_PRO')?' Pro':''). '</a> and <i class="fa fa-heart"></i>.',
'feed' => 'Feed',
