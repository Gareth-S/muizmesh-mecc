...
# lonelyplanet.fr/article/les-destinations-incontournables-en-europe-la-selection-lonely-planet
const CODENAME 			= 'PARIS'; // mb_strtoupper('tromsø', 'UTF-8') for uppercase
# Date de la build
const BUILD 			= '200402';
...
function langpack() {
	global $lang;
	return array('en-US'=>$lang['en-US'],'fr-FR'=>$lang['fr-FR'],'ru-RU'=>$lang['ru-RU'],'de-DE'=>$lang['de-DE'],'it-IT'=>$lang['it-IT']);
}
?>