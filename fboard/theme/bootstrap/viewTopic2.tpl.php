			...
			<div class="media my-3 p-3 bg-white rounded box-shadow">
			  ...
			  <div class="media-body">
                ...
                <div class="btn-group btn-group-sm">
					' .(!$topicEntry['locked']? 
					'<a class="btn btn-success" href="view.php' . DS . 'topic' . DS . $_GET['topic'] . DS . 'p' . DS . Util::onPage($_GET['topic'], $topicEntry['reply']). '#replyform"><i class="fa fa-reply"></i> ' .$lang['newreply']. '</a> 
