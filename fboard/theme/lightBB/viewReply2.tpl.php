			...
			<div id="' .$reply. '" class="media my-3 p-3 bg-white rounded box-shadow">
			  ...
			  <div class="media-body">
                ...
                <div class="btn-group btn-group-sm">
					' .(!$topicEntry['locked']? 
					'<a class="btn btn-success" href="view.php' . DS . 'topic' . DS . $replyEntry['topic'] . DS . 'p' . DS . Util::onPage($reply, $topicEntry['reply']). '#replyform" onclick="EditorTagInsert(\'content\', \'[quote]' .$reply. '\', \'[\/quote]\', 0);"><i class="fa fa-comments"></i> ' .$lang['quote_reply']. '</a> 
					<a class="btn btn-primary" href="view.php' . DS . 'topic' . DS . $replyEntry['topic'] . DS . 'p' . DS . Util::onPage($reply, $topicEntry['reply']). '#replyform"><i class="fa fa-reply"></i> ' .$lang['reply']. '</a> 
