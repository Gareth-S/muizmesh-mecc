...
<?php
			...
			{            
				foreach(array_values($forums) as $key => $forum)
				{
					...
					echo '<li class="dropdown-item"><span style="color:' .$forumEntry['badge_color']. '"><i class="' .$forumEntry['font_icon']. '"></i></span> <a href="view.php' . DS . 'forum' . DS . $forum. '">' .$forumEntry['name']. '</a>
					</li>';
				}
			}
			else
