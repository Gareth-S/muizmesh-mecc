class WebringBanner extends HTMLElement {
    constructor() {
        ...
        this.ringtitle = 'MuizenMesh Community Sites';
        this.url = 'https://muizenmesh.co.za/webring/';
        this.image = '/assets/images/freakazoid.jpg';
        this.membercount = 2;
