	...
	$out['content'] .= '
			...
			<div class="media my-3 p-3 bg-white rounded box-shadow">
			  ...
			  <div class="media-body">
			    ...
			    ' .$lastedited. '            
			    ' .($getTopic ? '<hr/><span style="color:#2D8C61;font-size:14px !important"><i class="fa fa-thumb-tack"></i> ' .Util::lang('%s stickied_discussion', $authoredit). '</span>' : '').
			            
			    ($topicEntry['locked'] ? '<hr/><span style="color:#d13e32;font-size:14px !important"><i class="fa fa-lock"></i> ' .Util::lang('%s locked_discussion', $authoredit). '</span>' : ''). '
