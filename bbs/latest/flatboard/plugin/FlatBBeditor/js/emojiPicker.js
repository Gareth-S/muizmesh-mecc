...
emojiTrigger.style=`position: absolute; top: 2px; right: 15px; text-decoration: none;`
...
emojiList.style=`padding: 0; margin: 0;list-style: none;`
...
const emojis=[0x1f60a, 0x1f600, 0x1f601, 0x1f602, 0x1f603, 0x1f604, 0x1f605,
...
emojis.map((item)=>{const emojiLi=document.createElement('li')
emojiLi.style=`display: inline-block; margin: 5px;`
const emojiLink=document.createElement('a')
emojiLink.style=`text-decoration: none; margin: 3px; position: initial; font-size: 20px;`
