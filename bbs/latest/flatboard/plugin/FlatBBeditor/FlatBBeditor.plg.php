...
{
	return array('font_size', 'font_color', 'bold', 'italic', 'underline', 'strike', 'code', 'quote', 'hide', 'align_center', 'align_right', 'insert_picture_width', 'insert_picture', 'insert_link', 'insert_youtube_video', 'insert_dailymotion_video', 'insert_video', 'upload_picture', 'fullscreen_editor');
}            	
/**
