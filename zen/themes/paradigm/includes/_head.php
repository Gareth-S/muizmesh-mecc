...
<title><?php
	if ($_zp_gallery_page == 'index.php') {echo getGalleryTitle(); echo ' | '; }
	...
	if ($_zp_gallery_page == 'image.php') {echo getBareImageTitle() . ' - photo from ' . getBareAlbumTitle(); echo ' | ';}
...
<?php
	if ($_zp_gallery_page == 'image.php' && isImagePhoto()) {echo '<meta property="og:image" content="';echo (PROTOCOL."://".$_SERVER['HTTP_HOST']); echo (getDefaultSizedImage()); echo '" />
';}
	if ($_zp_gallery_page == 'image.php' && !isImagePhoto()) {echo '<meta property="og:image" content="';echo (PROTOCOL."://".$_SERVER['HTTP_HOST']); echo (getImageThumb()); echo '" />
';}
...
if (($_zp_gallery_page == 'image.php') && getImageCustomData()!='') { echo '<meta property="og:description" content="'; echo getImageCustomData(); echo '"/>'; }
	elseif (($_zp_gallery_page == 'image.php') && getBareImageDesc()!='') { echo '<meta property="og:description" content="'; echo getBareImageDesc(); echo '"/>'; }
...
<meta name="twitter:site" content="<?php if (getOption('twitter_profile')!='') {
	...
	?>"/>
<meta name="twitter:title" content="<?php echo gettext('Home') . ' | '; echo getMainSiteName(); ?>" />
<meta name="twitter:description" content="<?php echo getGalleryTitle();  echo ' #zenphoto '; echo  gettext('album') ?>"  />
...
<script>
  ...
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
	...
	ga('set', 'contentGroup1', '<?php
		if (($_zp_gallery_page == 'index.php')) {echo '00 homepage';}
		if ($_zp_gallery_page == 'album.php') {echo '20 album';}
		if ($_zp_gallery_page == 'gallery.php') {echo '00 gallery-homepage';}
		if ($_zp_gallery_page == '404.php') {echo '90 error';}
		if ($_zp_gallery_page == 'archive.php') {echo '80 utility';}
		if ($_zp_gallery_page == 'contact.php') {echo '80 utility';}
		if ($_zp_gallery_page == 'favorites.php') {echo '80 utility';}
		if ($_zp_gallery_page == 'image.php') {echo '30 image';}
		if (($_zp_gallery_page == 'news.php') && (!is_NewsArticle())) {echo '40 news list';}
		if (($_zp_gallery_page == 'news.php') && (is_NewsArticle())) {echo '45 news';}
		if (($_zp_gallery_page == 'pages.php')||($_zp_gallery_page == 'credits.php')) {echo '10 page';}
		if ($_zp_gallery_page == 'password.php') {echo '80 utility';}
		if ($_zp_gallery_page == 'register.php') {echo '80 utility';}
		if ($_zp_gallery_page == 'search.php') {echo '50 tag';}
	?>');
	ga('set', 'contentGroup2', '<?php
		if ($_zp_gallery_page == 'album.php') {echo getAlbumTitle();}
		if ($_zp_gallery_page == 'image.php') {echo getAlbumTitle();}
		if ($_zp_gallery_page == 'news.php') {echo printCurrentNewsCategory();}
	?>');  
	ga('send', 'pageview');
